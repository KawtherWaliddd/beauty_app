...
A **Flutter-based beauty application** that provides users with a simple and elegant interface to browse beauty services, explore products, and book appointments easily.  
This project was developed as the **final project for ITI training**, focusing on Flutter development, clean architecture, and responsive UI design.
...
| **MVVM Architecture** | Clean and maintainable app structure |
...
The app follows a **simple MVVM-inspired structure**, with manual state handling (no Bloc or Provider).  
All API calls are handled using **Dio** through a reusable `ApiClient` class.
